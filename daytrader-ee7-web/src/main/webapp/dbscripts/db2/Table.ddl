...
CREATE LARGE TABLESPACE "HOLDING_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "HOLDING_BP" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNTP_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNTP_BP" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_BP" AUTORESIZE YES FILE SYSTEM CACHING;

CREATE LARGE TABLESPACE "QUOTE_ITS1" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP1" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS2" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP2" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS3" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP3" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS4" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP4" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS5" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP5" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS6" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP6" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS7" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP7" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS8" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP8" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS9" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP9" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS10" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP10" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS11" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP11" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS12" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP12" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS13" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP13" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS14" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP14" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS15" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP15" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS16" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP16" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS17" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP17" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS18" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP18" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS19" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP19" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "QUOTE_ITS20" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "QUOTE_IBP20" AUTORESIZE YES FILE SYSTEM CACHING;

CREATE LARGE TABLESPACE "ACCOUNT_ITS1" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP1" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS2" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP2" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS3" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP3" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS4" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP4" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS5" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP5" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS6" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP6" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNT_ITS7" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNT_IBP7" AUTORESIZE YES FILE SYSTEM CACHING;

CREATE LARGE TABLESPACE "KEYGENE_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "KEYGENE_BP" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ACCOUNTE_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ACCOUNTE_BP" AUTORESIZE YES FILE SYSTEM CACHING;
CREATE LARGE TABLESPACE "ORDER_TS" PAGESIZE 4096 MANAGED BY AUTOMATIC STORAGE  BUFFERPOOL "ORDER_BP" AUTORESIZE YES FILE SYSTEM CACHING;
